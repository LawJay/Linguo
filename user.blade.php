        ...
        <div class="tabbable">
            ...
            <div class="tab-content no-border padding-24">
                    ...
                    <div class="row">
                        <div class="col-xs-12 col-sm-3 center">
							<span class="profile-picture">
								<img class="editable img-responsive" alt=" Avatar" id="avatar2" height="75%" width="75%" src="{{ route('account.image', ['name' => $user->name . '-' . $user->id . '.jpg']) }}">
							</span>
    		  ...
    		  <div class="popup-head">
				<div class="popup-head-left pull-left"><img src="http://bootsnipp.com/img/avatars/bcf1c0d13e5500875fdd5a7e8ad9752ee16e7462.jpg" alt="iamgurdeeposahan"> {{$user->name}}</div>
			...
			<button class="bg_none"><i class="material-icons">camera_front</i></i> </button>
			<button class="bg_none"><i class="material-icons">camera_alt</i></i> </button>
            <button class="bg_none"><i class="material-icons">attach_file</i></i> </button>
			<button class="bg_none pull-right"><i class="material-icons">thumb_up</i> </button>
			</div>
			</div>
	  </div>
                                    </div>
